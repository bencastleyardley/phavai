...
const mock: TopResponse = {
  ...
  picks: [
    { rank: 1, title: "La Sportiva Prodigio Pro", url: "#", price: "$199", score: 92, confidence: 0.84, badge: "Best Overall",
      highlights: ["Fast, stable midsole","Excellent grip on wet rock","Durable upper"],
      sources: [{ type:"review",count:8 },{ type:"reddit",count:12 },{ type:"youtube",count:5 }] },
    { rank: 2, title: "Saucony Peregrine", url: "#", price: "$140", score: 88, confidence: 0.81, badge: "Best Value",
      highlights: ["Great all-rounder","Protective rock plate","Broad fit range"],
      sources: [{ type:"review",count:6 },{ type:"reddit",count:10 },{ type:"youtube",count:4 }] },
    { rank: 3, title: "HOKA Speedgoat", url: "#", price: "$155", score: 86, confidence: 0.79,
      highlights: ["Cushioned for ultra distance","Vibram grip","Locks heel well"],
      sources: [{ type:"review",count:7 },{ type:"reddit",count:9 },{ type:"youtube",count:4 }] }
  ]
};
